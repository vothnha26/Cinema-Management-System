...
public interface PricingService {
    ...
    com.example.cinema.model.dto.response.PriceCalculationResult calculateTicketPrice(Showtime showtime, Seat seat, com.example.cinema.model.entity.Customer customer);
}
