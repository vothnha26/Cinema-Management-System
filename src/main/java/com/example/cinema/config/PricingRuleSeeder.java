...
public class PricingRuleSeeder {
    ...
    @Bean
    @Order(10)
    public CommandLineRunner initPricingRules(PricingRuleService pricingRuleService,
            com.example.cinema.repository.branch.BranchRepository branchRepository) {
        return args -> {
            if (!pricingRuleService.getAllRules().isEmpty())
                return;
            ...
            happyWednesday.addCondition(new PricingCondition(happyWednesday, PricingConditionType.DAY_OF_WEEK,
                    "WEDNESDAY", "Chỉ áp dụng Thứ 4"));
            ...
            earlyBird.addCondition(new PricingCondition(earlyBird, PricingConditionType.TIME_RANGE, "00:00-10:00",
                    "Trước 10 giờ sáng"));
            ...
            weekendSurcharge.addCondition(new PricingCondition(weekendSurcharge, PricingConditionType.DAY_OF_WEEK,
                    "SATURDAY,SUNDAY", "Thứ 7 & Chủ Nhật"));
            ...
            if (branchQ1 != null) {
                ...
                q1Special.addCondition(new PricingCondition(q1Special, PricingConditionType.BRANCH,
                        String.valueOf(branchQ1.getId()), "Chi nhánh Quận 1"));
            ...
            goldDiscount.addCondition(
                    new PricingCondition(goldDiscount, PricingConditionType.MEMBER_TIER, "GOLD", "Dành cho hạng GOLD"));
