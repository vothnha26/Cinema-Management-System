...
public class MovieRequest {
    ...
    // Compatibility fields for Service Layer
    ...
    public String getDirectorAvatarUrl() {
        return directorAvatarUrl;
    }

    public void setDirectorAvatarUrl(String url) {
        this.directorAvatarUrl = url;
    }

    public String getActorAvatarUrls() {
        return actorAvatarUrls;
    }

    public void setActorAvatarUrls(String urls) {
        this.actorAvatarUrls = urls;
    }
